			...
			<div className="space-y-6">
				<div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
					...
					<p className="text-sm text-gray-400">
						Run <code className="text-violet-400">bun run dev config</code> to view current
						settings, or <code className="text-violet-400">bun run dev setup</code> to reconfigure.
					</p>
				</div>
				...
				<div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
					...
					<p className="text-sm text-gray-500">AI Eraser v0.1.0 — Built by CushLabs AI Services</p>
				</div>
			</div>
		</div>
	);
